...
namespace CMS.Alportech.Cliente.VictoriaCaroline.Controllers
{
    public class AreasAtuacaoController : Controller
    {
        ...
        public async Task<IActionResult> AdicionarAreaAtuacao([FromBody] AreaAtuacao areaAtuacao)
        {
            ...
            var url = "https://script.google.com/macros/s/AKfycbz_8T8rGUFNw6hktn9Aos72T5u5kcSR_mr14tW-2WYMS72J99irPFvDcmP1NyxJbu4qIg/exec";
        ...
        public async Task<IActionResult> EditarAreaAtuacao([FromBody] AreaAtuacao areaAtuacao)
        {
            ...
            var deletarUrl = "https://script.google.com/macros/s/AKfycbxp-8RqTRtuyFNO-8QqOeL2-7dFgAxfMMjlZcECp3C_oH_XzyFYY8gyTp_EAAY673A95Q/exec";
            ...
            var registrarUrl = "https://script.google.com/macros/s/AKfycbz_8T8rGUFNw6hktn9Aos72T5u5kcSR_mr14tW-2WYMS72J99irPFvDcmP1NyxJbu4qIg/exec";
        ...
        public async Task<IActionResult> DeletarAreaAtuacao(string idAreaAtuacao)
        {
            ...
            var url = "https://script.google.com/macros/s/AKfycbxp-8RqTRtuyFNO-8QqOeL2-7dFgAxfMMjlZcECp3C_oH_XzyFYY8gyTp_EAAY673A95Q/exec";
